...
const dependencies = {
    mobx: ['mobx:^5.9.4', 'mobx-react:^5.4.4', 'mobx-react-devtools:^6.1.1']
};
...
module.exports = class extends Generator {
    prompting() {
        this.log(
            yosay(
                `Yo! Let me help you quickly set up your ${chalk.yellow('React')} webapp with ${chalk.yellow(
                    'TypeScript'
                )}. Please make sure that you have ${chalk.red('Yarn')} installed before continuing.`,
                { maxLength: 40 }
            )
        );
    ...
    install() {
        ...
        const message = this.options['skip-install']
            ...
            : `Congratulations! Your '${chalk.yellow(
                  this._appName
              )}' app is successfully set up. Please run '${chalk.yellow('npm start')}' to get started.`;
